...
namespace LegacyOfShadows.NewContent.NinjaTricks
{
    internal class AccelerationOfForm
    {
        ...
        public static void ConfigureAccelerationOfForm()
        {
            ...
            var AccelerationOfFormIcon = AssetLoader.LoadInternal(LoSContext, folder: "assets/icons", file: "AccelerationOfForm.png");


            var AccelerationOfFormAbility = Helpers.CreateBlueprint<BlueprintAbility>(LoSContext, "NinjaTrickAccelerationOfFormAbility", bp => {
                bp.SetName(LoSContext, AccelerationOfFormFeatureName);
